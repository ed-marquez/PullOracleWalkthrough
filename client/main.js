...
const gRPCAddress = 'testnet-dora.supraoracles.com'; // Set the gRPC server address. 'mainnet-dora.supraoracles.com' or 'testnet-dora.supraoracles.com' depending on where your contract is deployed.
const pairIndexes = [0, 21, 61, 49]; // Set the pair indexes that you wish to request/use as an array - https://supra.com/docs/data-feeds/data-feeds-index
...
const walletAddress = '<WALLET ADDRESS>'; //Your wallet address
const privateKey = '<PRIVATE KEY>'; //Your private key
//-----------------------------------------------------------------------------------------------------------------
